...
create index idx_whatsapp_sessions_project on whatsapp_sessions(project_id);
create index idx_contacts_tenant on contacts(tenant_id);
create index idx_contacts_project_phone on contacts(project_id, phone);
...
create index idx_knowledge_items_active on knowledge_items(is_active);
...
-- All tenant-scoped tables: users can access rows for their own tenant
...
-- Reusable helper: apply same policy to all other tenant-scoped tables
do $$ begin
    -- whatsapp_sessions
